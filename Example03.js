...
http.createServer(function(req, res){ // http.createServer([requestListener]) | The requestListener is a function which is automatically added to the 'request' event.
    ...
    /*if (operator1 == 2) {
       console.log("Putting both leds ON");
    ...
    /*if (operator2 == 2) {
       console.log("Putting both leds Off");
        board.digitalWrite(8, board.LOW);
       board.digitalWrite(13, board.LOW);
    }*/
    ...
    res.write("for test write \"172.16.22.209:8080/1\" into the browser \n");
    res.end("The value of operator1: " + operator1 + "\nThe value of operator2: " + operator2);
}).listen(8080, "172.16.22.209");